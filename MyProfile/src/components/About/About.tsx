        ...
        <div className='flex'>
          ...
          <div className='text-left px-2'>
            ...
            <div className='py-1'>
              ...
              <p className='py-1 text-sm lg:text-base xl:text-xl'>{t('about1')}</p>
              <p className='py-1 text-sm lg:text-base xl:text-xl'>{t('about2')}</p>
              <p className='py-1 text-sm lg:text-base xl:text-xl'>{t('about3')}</p>
              <p className='py-1 text-sm lg:text-base xl:text-xl'>{t('about4')}</p>
            </div>
          </div>
        </div>
      </div>
